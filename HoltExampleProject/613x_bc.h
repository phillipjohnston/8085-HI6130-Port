...
typedef volatile unsigned short (*GPQ)[64] ;
...
typedef struct bc_inst_list {
  volatile unsigned short opCode;
  volatile unsigned short param;
...
typedef volatile unsigned short HI6130_RAM ; // half-word (16-bits) 
